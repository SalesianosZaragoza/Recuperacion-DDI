...
<html>
    ...
    <body>
        <h3 class="mx-3 mt-2 danger">Añadir nuevo alumno</h3>
        <form action="/welcome" method="post" class="form-inline">
        ...
        <a class="mx-3  link-secondary" href="ListaVotar">Votar delegado</a>
