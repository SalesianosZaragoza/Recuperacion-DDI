...
public class VoteServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                String datosAlumno[] = { resultSet.getString(1), resultSet.getString(2), resultSet.getString(3),
                        resultSet.getString(4), resultSet.getString(5), resultSet.getString(6), String.valueOf(0)};
        ...
        RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/votar.jsp");
