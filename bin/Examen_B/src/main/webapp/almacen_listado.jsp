				...
				<c:forEach var="almacen" items="${almacenes_old}">
					<tr>
						...
						<td><c:out value="${almacen.getName()}"/></td>
					 	...
					 	<td class="col-1 text-right"><a href='/editarAlmacen?id=${almacen.getId()}&type=old' class="btn btn-success" role="button" aria-disabled="true">Editar</a></td>
					 	<td class="col-1 text-left"><a href='/borrarAlmacen?id=${almacen.getId()}&type=old' class="btn btn-danger" role="button" aria-disabled="true">Borrar</a></td>
			    	</tr>
				</c:forEach>
			  </tbody>
			</table>
				...
				<c:forEach var="almacen" items="${almacenes_new}">
					<tr>
						...
						<td><c:out value="${almacen.getName()}"/></td>
					 	...
					 	<td class="col-1 text-right"><a href='/editarAlmacen?id=${almacen.getId()}&type=new' class="btn btn-success" role="button" aria-disabled="true">Editar</a></td>
					 	<td class="col-1 text-left"><a href='/borrarAlmacen?id=${almacen.getId()}&type=new' class="btn btn-danger" role="button" aria-disabled="true">Borrar</a></td>
			    	</tr>
				</c:forEach>
			  </tbody>
			</table>
